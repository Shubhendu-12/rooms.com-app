...
import hotel_Icon from '../assets/icons/hotel_Icon.png'
...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <Link to ="/" className="flex items-center">
      <img src={hotel_Icon} className="h-8 mr-3" alt="Room Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Rooms.Com</span>
  </Link>
